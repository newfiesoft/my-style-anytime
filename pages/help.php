...
function mysat_render_help_page(): void {
 ...
 <img class="img-panel-info" src="<?php echo $plugin_dir_url . 'assets/img/help/cPanel-file-manager.png' ?>" alt=""/>
 ...
 <img class="img-panel-info" src="<?php echo $plugin_dir_url . 'assets/img/help/Plesk-file-manager.png' ?>" alt=""/>
        <p style="padding-top:10px;">
        </p>
    ...
    <div class="license-container">
        ...
        <img class="img-cover-info" src="<?php echo $plugin_dir_url . 'assets/img/help/Note_pad_pp_logo.png' ?>"
             alt=""/>
        <p style="padding-top:10px;">
        </p>
