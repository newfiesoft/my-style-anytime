...
function mysat_render_custom_page(): void {
	...
	if ( isset( $_POST['mysat_login_settings_nonce'] ) && wp_verify_nonce( $_POST['mysat_login_settings_nonce'], 'mysat_login_settings_action' ) ) {
		...
		$new_custom_bg_color = isset($_POST['mysat_custom_bg_color']) ? sanitize_hex_color( $_POST['mysat_custom_bg_color'] ) : '#ffffff';
